...
import org.fao.gift.output.data.dto.MDSDescriptor;
import org.fao.gift.output.data.logic.DataCreator;
import org.fao.gift.output.layout.StandardLayoutCreator;
import org.fao.gift.output.utils.ColorType;
import org.fao.gift.output.utils.MDFontTypes;
...
@org.fao.fenix.commons.utils.annotations.export.Output("outputSurvey")
public class GiftSurveyOutput extends Output {

    private static final Logger log = Logger.getLogger(GiftSurveyOutput.class);
    ...
    public void process(CoreData resource) throws Exception {
        ...
        StandardLayoutCreator layoutCreator = StandardLayoutCreator.getInstance();
        layoutCreator.register(document, template);
