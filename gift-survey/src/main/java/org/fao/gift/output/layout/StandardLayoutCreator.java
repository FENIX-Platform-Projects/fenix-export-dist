package org.fao.gift.output.layout;
...
import org.fao.gift.output.utils.RegistrationFont;
import org.fao.gift.output.utils.SpecialBean;
import org.fao.gift.output.utils.SpecialDateBean;
...
public class StandardLayoutCreator {
...
*/
    ...
    private static StandardLayoutCreator instance;

    private StandardLayoutCreator() {}

    public static StandardLayoutCreator getInstance () {
        if(instance == null)
            instance = new StandardLayoutCreator();
        return instance;
    }


    public void register (Document document, String template) throws DocumentException {
